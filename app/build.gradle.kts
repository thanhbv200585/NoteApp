...
dependencies {
    ...
    implementation("org.jetbrains.exposed:exposed-core:0.38.2") // For Exposed
    implementation("org.jetbrains.exposed:exposed-dao:0.38.2") // For Exposed
    implementation("org.jetbrains.exposed:exposed-jdbc:0.38.2") // For Exposed
